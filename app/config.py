...
class Settings(BaseSettings):
    ...
    # Database
    DATABASE_URL: str = "postgresql://eccomerce_owner:npg_ZG59dIFlOBga@ep-ancient-pine-ac91ogbe-pooler.sa-east-1.aws.neon.tech/eccomerce?sslmode=require&connect_timeout=10&application_name=eccomerce_api"
